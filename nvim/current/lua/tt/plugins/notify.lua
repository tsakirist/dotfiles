...
function M.setup()
    ...
    -- vim.api.nvim_set_hl(0, "NotifyINFOBorder", { fg = colors.blue.base })
    -- vim.api.nvim_set_hl(0, "NotifyINFOIcon", { fg = colors.blue.base })
    -- vim.api.nvim_set_hl(0, "NotifyINFOTitle", { fg = colors.blue.base })
